...
import com.br.casevault.dto.StudentDto;
import com.br.casevault.exception.ResourceNotFoundException;
import com.br.casevault.model.entity.Student;
import com.br.casevault.model.entity.User;
import com.br.casevault.repository.StudentRepository;
...
public class StudentService {
    ...
    public static StudentDto.Response toResponse(Student s) {
        ...
        r.setCgpa(s.getCgpa());
        r.setSkills(com.br.casevault.util.MatchingService.split(s.getSkills()));
