package com.br.casevault.service;

import com.br.casevault.dto.ApplicationDto;
import com.br.casevault.dto.CompanyDto;
import com.br.casevault.dto.JobDto;
import com.br.casevault.dto.UserResponse;
import com.br.casevault.model.enums.ApplicationStatus;
import com.br.casevault.model.enums.JobStatus;
import com.br.casevault.repository.*;
import com.br.casevault.service.ApplicationService;
import com.br.casevault.service.CompanyService;
import com.br.casevault.service.JobService;
...
public class AdminService {
    ...
    public List<CompanyDto.Response> listCompanies(Boolean verified) {
        List<com.br.casevault.model.entity.Company> list = verified == null ? companies.findAll() : companies.findByVerified(verified);
        return list.stream().map(CompanyService::toResponse).toList();
    }

    public List<JobDto.Response> listJobs(JobStatus status) {
        List<com.br.casevault.model.entity.JobPosting> list = status == null ? jobs.findAll() : jobs.findByStatus(status);
    ...
    public List<ApplicationDto.Response> listApplications(ApplicationStatus status) {
        List<com.br.casevault.model.entity.Application> list = status == null ? applications.findAll() : applications.findByStatus(status);
