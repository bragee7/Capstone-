...
import com.br.casevault.service.*;
...
public class WorkflowController {
    ...
    private final com.br.casevault.util.SecurityUtils security;
    ...
    public WorkflowController(InterviewService interviews, OfferService offers,
                              ...
                              com.br.casevault.util.SecurityUtils security) {
    ...
    public ResponseEntity<ApiResponse<?>> adminJobs(
        ...
        com.br.casevault.model.enums.JobStatus js = null;
        if (status != null && !status.isBlank()) {
            try { js = com.br.casevault.model.enums.JobStatus.valueOf(status.toUpperCase()); } catch (IllegalArgumentException ignored) {}
        }
    ...
    public ResponseEntity<ApiResponse<?>> adminApplications(
            @RequestParam(required = false) String status) {
        com.br.casevault.model.enums.ApplicationStatus s = null;
        if (status != null && !status.isBlank()) {
            try { s = com.br.casevault.model.enums.ApplicationStatus.valueOf(status.toUpperCase()); } catch (IllegalArgumentException ignored) {}
        }
